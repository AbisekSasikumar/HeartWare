...
class SensorGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("ESP32 Real-Time Sensor Dashboard")
    ...
    def create_widgets(self):
        ...
        # Labels for static sensors
        self.info_frame = tb.Frame(self.root)
        self.info_frame.pack(pady=5)

        self.altitude_label = tb.Label(self.info_frame, text="Altitude: -- m", font=("Segoe UI", 12))
        self.altitude_label.pack(side='left', padx=20)

        self.pressure_label = tb.Label(self.info_frame, text="Pressure: -- hPa", font=("Segoe UI", 12))
        self.pressure_label.pack(side='left', padx=20)
        ...
        # Plot Frame
        self.plot_frame = tb.LabelFrame(self.root, text="📈 Live Sensor Plot")
...
if __name__ == '__main__':
    root = tb.Window(themename="flatly")  # Try: darkly, morph, lumen, etc.
    app = SensorGUI(root)
